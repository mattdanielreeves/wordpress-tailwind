                    ...
                    if ($enable_submenu) {
                        ...
                        if (!empty($submenu_items)) {
                            ...
                            foreach ($submenu_items as $submenu_item) {
                                if (is_object($submenu_item) && isset($submenu_item->ID)) {
                ...
                if (is_array($parent_menu_item)) {
                    ...
                    if (have_rows('mega_menu') && !$enable_submenu):
                        ...
                        echo '<div x-show="isOpen" x-transition:enter="transition ease-in-out duration-300"
                            ...
                            class="h-full max-h-[60vh] absolute left-0 right-0 top-52 w-full ' . $background_color . ' py-10 z-10">';

                        echo '<div class="relative grid grid-cols-4 grid-rows-3  max-w-screen-xl h-full mx-auto p-6">';
