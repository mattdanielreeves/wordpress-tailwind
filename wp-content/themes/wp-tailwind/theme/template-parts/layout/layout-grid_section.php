...
<div style="background-color:<?php echo $background; ?>"
  class="grid grid-cols-12 grid-flow-row auto-rows-auto auto-cols-fr mx-autow-full <?php echo esc_attr($args['width'] ?? ''); ?>">
  <div class="grid grid-cols-12 grid-flow-row auto-rows-auto auto-cols-fr mx-auto col-span-12">
    <?php
    global $blockNumber;
    $blockNumber = 0;
